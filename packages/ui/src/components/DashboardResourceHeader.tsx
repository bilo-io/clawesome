...
// We abstract the routing components to be passed in or use standard ones if available
// For now we assume the consumer provides a Link component or we use a basic anchor
// To maintain compatibility with Next.js, we expect a polymorphic link or just use strings
