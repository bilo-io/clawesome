      ...
      >
        {showThoughts && (
          <div className={cn(
            ...
            <header className={cn(
              "h-20 border-b flex items-center gap-2 px-6 text-[10px] font-black uppercase tracking-[0.2em] shrink-0",
        ...
        <div className="w-[400px] flex flex-col h-full shrink-0">
          <header className={cn(
            "h-20 border-b flex items-center px-6 backdrop-blur-xl shrink-0",
          ...
          {/* Tighter Tabs Row */}
          <div className={cn(
             "h-12 border-b flex items-center gap-2 overflow-x-auto no-scrollbar px-6 shrink-0",
