  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className={cn(
        "w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all absolute top-5 left-5 z-20 cursor-pointer",
        selected 
      ...
      <div onClick={onClick} className="relative z-10 pl-2 mt-4">
